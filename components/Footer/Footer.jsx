...
export default function Footer() {
 ...
 <button className={styles.subscribeButton} onClick={handleSubscribe}>
     ...
     To get in touch with our helpful Customer Service team, please <Link aria-label="Send message for any question or concern you might have" href='/contact-us'>click here</Link>. They will respond to all your questions and enquiries ASAP.
       </span>
      </LinkCard>
