...
export default function Footer() {
 ...
 <button className={styles.subscribeButton} onClick={handleSubscribe}>
     ...
     To get in touch with our helpful Customer Service team, please <Link aria-label="Send us a message" href='/contact-us'>click here</Link>. They will respond to all your questions and enquiries ASAP.
       </p>
      </LinkCard>
